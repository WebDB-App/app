 ...
 * @experimental
 */
export declare type BSONElement = [
	type: number,
	nameOffset: number,
	nameLength: number,
	offset: number,
 ...
 * @public
 */
export declare function calculateObjectSize(object: Document$1, options?: CalculateObjectSizeOptions): number;
/** @public */
...
export declare class Code extends BSONValue {
	get _bsontype(): "Code";
	code: string;
	scope: Document$1 | null;
	/**
	 * @param code - a string or function.
	 * @param scope - an optional scope for the function.
	 */
	constructor(code: string | Function, scope?: Document$1 | null);
	toJSON(): {
		code: string;
		scope?: Document$1;
	};
...
export declare class DBRef extends BSONValue {
	 ...
	 */
	constructor(collection: string, oid: ObjectId, db?: string, fields?: Document$1);
	/* Excluded from this release type: namespace */
	/* Excluded from this release type: namespace */
	toJSON(): DBRefLike & Document$1;
	/* Excluded from this release type: toExtendedJSON */
	/* Excluded from this release type: fromExtendedJSON */
	inspect(depth?: number, options?: unknown, inspect?: InspectFn): string;
}
 ...
 * @public
 */
export declare function deserialize(buffer: Uint8Array, options?: DeserializeOptions): Document$1;
/** @public */
 ...
 * @public
 */
export declare function deserializeStream(data: Uint8Array | ArrayBuffer, startIndex: number, numberOfDocuments: number, documents: Document$1[], docStartIndex: number, options: DeserializeOptions): number;
/** @public */
declare interface Document$1 {
	[key: string]: any;
}
/**
 ...
 * @public
 */
export declare function serialize(object: Document$1, options?: SerializeOptions): Uint8Array;
/** @public */
 ...
 * @public
 */
export declare function serializeWithBufferAndIndex(object: Document$1, finalBuffer: Uint8Array, options?: SerializeOptions): number;
/**
